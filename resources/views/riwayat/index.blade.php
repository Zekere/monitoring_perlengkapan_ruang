        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-2 p-md-3">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <select name="jenis_perubahan" class="form-select form-select-sm">
                                    ...
                                    <option value="Kondisi" {{ request('jenis_perubahan') == 'Kondisi' ? 'selected' : '' }}>Kondisi</option>
                    ...
                    <!-- Info Total Data -->
                    {{-- Karena sudah pakai get() bukan paginate(), gunakan count() --}}
                    <div class="mb-3">
                        ...
                        <table class="table table-bordered table-striped table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('riwayat.show', $r->id_item) }}" class="text-primary">
...
.form-select-sm, .form-control-sm { font-size: 0.875rem; padding: 0.375rem 0.75rem; }
@media (max-width: 576px) {
    .form-select-sm, .form-control-sm { font-size: 0.8rem; padding: 0.375rem 0.5rem; }
}
